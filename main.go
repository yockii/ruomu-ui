	...
	// 注入信息
	{
		mjiList := []*moduleModel.ModuleInjectInfo{
			...
			},
			{
				...
				Name:              "新增组件库版本",
				Type:              2,
				InjectCode:        constant.InjectCodeMaterialLibVersionAdd,
				AuthorizationCode: "materialLibVersion:add",
			},
			{
				ID:                util.SnowflakeId(),
				ModuleID:          m.ID,
				Name:              "修改组件库版本",
				Type:              3,
				InjectCode:        constant.InjectCodeMaterialLibVersionUpdate,
				AuthorizationCode: "materialLibVersion:update",
			},
			{
				ID:                util.SnowflakeId(),
				ModuleID:          m.ID,
				Name:              "删除组件库版本",
				Type:              4,
				InjectCode:        constant.InjectCodeMaterialLibVersionDelete,
				AuthorizationCode: "materialLibVersion:delete",
			},
			{
				ID:                util.SnowflakeId(),
				ModuleID:          m.ID,
				Name:              "获取组件库版本列表",
				Type:              1,
				InjectCode:        constant.InjectCodeMaterialLibVersionList,
				AuthorizationCode: "materialLibVersion:list",
			},
			{
				ID:                util.SnowflakeId(),
				ModuleID:          m.ID,
				Name:              "获取组件库版本详情",
				Type:              1,
				InjectCode:        constant.InjectCodeMaterialLibVersionInstance,
				AuthorizationCode: "materialLibVersion:instance",
			},
			{
				ID:                util.SnowflakeId(),
				ModuleID:          m.ID,
