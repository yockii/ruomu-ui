...
type Page struct {
	...
	Description string `json:"description,omitempty" gorm:"size:255;comment:'页面描述'"`
	...
	FileName    string `json:"fileName,omitempty" gorm:"size:50;comment:'文件名'"`
...
func (p *Page) UnmarshalJSON(b []byte) error {
	...
	p.FileName = j.Get("fileName").String()
